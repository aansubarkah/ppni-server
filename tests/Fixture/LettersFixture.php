...
class LettersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'via_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'date' => '2015-10-20',
            'created' => '2015-10-20 03:59:08',
            'modified' => '2015-10-20 03:59:08',
            'active' => 1
        ],
    ];
}
